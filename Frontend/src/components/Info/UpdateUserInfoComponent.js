...
//         productsInterested: user.productsInterested || "",
//         notificationPreferences: user.notificationPreferences || { email: true, sms: false },
//       });
//     }
//   }, [user]);
...
//     try {
//       await dispatch(updateUserInfo(userInfoData));
...
//         {/* Right Side: Update User Info Form */}
